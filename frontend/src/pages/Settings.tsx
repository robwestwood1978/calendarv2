...
// Baseline Settings page + additive Slice C toggle & Account panel.
// Exports a *default* component so main.tsx's default import works.
...
function AccountPanel() {
  const settings = useSettings() // returns the settings object (members is guaranteed an array)
